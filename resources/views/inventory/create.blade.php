        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('inventory.store') }}" class="max-w-2xl" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <!-- Drop Zone -->
                            <div id="large-dropzone" class="img-uploader-zone mt-2 py-10 flex flex-col items-center justify-center gap-2">
                            ...
                            <!-- Tile grid -->
                            <div id="image-grid" class="hidden mt-3">
                                ...
                                <p class="uploader-counter" id="img-counter">0 / 5 photos</p>
                            </div>
                        ...
                        <div class="flex items-center gap-4 mt-6">
                            <button type="submit" class="bg-gray-800 text-white px-5 py-2 rounded-lg hover:bg-gray-700 text-sm font-bold uppercase tracking-widest transition-colors">Add Product</button>
    ...
    <script>
        ...
        function addFiles(list) {
            ...
            Array.from(list).forEach(f => {
                if (files.length >= MAX)          { errs.push(`Max ${MAX} images allowed.`); return; }
        ...
        function removeFile(i) { files.splice(i, 1); sync(); render(); }
        ...
        function render() {
            ...
            imageGrid.classList.toggle('hidden', files.length === 0);
            addMoreTile.style.display = files.length >= MAX ? 'none' : 'flex';
            counter.textContent = `${files.length} / ${MAX} photos`;
            tileRow.querySelectorAll('.img-tile').forEach(el => el.remove());
